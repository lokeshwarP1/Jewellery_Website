...
const Generate: React.FC = () => {
  ...
  >
    <div className="relative group">
      <img
        src={imagePreview}
        alt="Uploaded sketch"
        className="rounded-xl object-cover shadow-lg cursor-pointer transition-transform group-hover:scale-[1.02]"
        width={256}
        height={256}
  ...
  >
    ...
    <motion.button
      ...
      className="py-4 px-6 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center justify-center space-x-3"
      whileHover={{ scale: 1.02 }}
      whileTap={{ scale: 0.98 }}
    >
